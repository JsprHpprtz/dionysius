<footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
  <aside>
    ...
    <p>
        Dionysius
      <br />
       © {{ date('Y') }}. Alle rechten voorbehouden. — Dionysius
    </p>
  </aside>
  <nav>
    <h6 class="footer-title">Contactgegevens bestuur</h6>
    <a href="https://maps.app.goo.gl/g4Pctw4XEaa1viKg9" target="_blank" rel="noopener noreferrer" class="underline hover:text-primary">
        Westerpark 80
        <p>5042 MH Tilburg</p>
    </a>
    <p>bestuur@dionysius.nl</p>
  </nav>
  <nav>
    <h6 class="footer-title">Social Media</h6>
    <div class="flex gap-4">
      <a href="https://www.facebook.com/gtvdionysius" target="_blank" rel="noopener noreferrer" class="social-icon-link">
      ...
      <a href="https://www.instagram.com/gtvdionysius/" target="_blank" rel="noopener noreferrer" class="social-icon-link">
      ...
      <a href="https://www.tiktok.com/@dionysius_turnclub" target="_blank" rel="noopener noreferrer" class="social-icon-link">
  ...
  <nav>
    <h6 class="footer-title">Contactgegevens ledenadministratie</h6>
    <a href="https://maps.app.goo.gl/pB9ZtKXDuTRkxcaa7" target="_blank" rel="noopener noreferrer" class="underline hover:text-primary">
        Herwijnenstraat 43
        <p>5045 GP Tilburg</p>
    </a>
    <p>ledenadministratie@dionysius.nl</p>
  </nav>
  <nav>
  ...
  <nav>
    <h6 class="footer-title">Rekeningnummer contributie</h6>
    <p>IBAN: NL 36 INGB 000 375 9771</p>
    <p>BIC: INGBNL2A</p>
  </nav>
</footer>
